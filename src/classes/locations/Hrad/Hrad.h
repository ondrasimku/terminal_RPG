#ifndef SIMKUOND_HRAD_H
#define SIMKUOND_HRAD_H
#include "../Location.h"

class Hrad : public Location {
public:
    /**
     * @brief Constructs Hrad location.
     *
     * @param name _string_ name of location
     * @param idx  _int_ index of this location inside _Game_'s _m_locations_ vector
     */
    Hrad(const std::string &name, int idx);
